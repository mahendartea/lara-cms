...
<head>
    ...
    <title>{{ $title ?? 'Partai Perjuangan Aceh' }}</title>

    <link rel="icon" href="/assets/img/logoPPA.png" type="image/x-icon">
...
<body>
    ...
    <footer class="bg-[#040181] dark:bg-gray-900 text-white mt-10 pt-10 pattern">
        <div class="container p-6 mx-auto">
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <a href="#" class="my-5">
                            <img class="w-auto h-32" src="/assets/img/logoPPA.png" alt="">
                            <p class="text-[#faec04]">Parta Perjuangan Aceh</p>
                        </a>

                        <p class="max-w-sm mt-2 dark:text-gray-400">Membangun Kembali Masyarakat Aceh Maju dan Sejahtera
                        </p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <a href="#" class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Informasi
                                Publik</a>
                            <a href="#" class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Seputar
                                Partai</a>
                            <a href="#" class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Visi
                                Misi</a>
                        </div>

                        <div>
                            <h3 class=" uppercase dark:text-white">Blog</h3>
                            <a href="#" class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Berita</a>
                            <a href="#"
                                class="block mt-2 text-sm  dark:text-gray-400 hover:underline">Kegiatan</a>
            ...
            <div>
                <p class="text-center dark:text-gray-400">© Partai Perjuangan Aceh 2024 - All rights reserved</p>
            </div>
        </div>
    </footer>
</body>
