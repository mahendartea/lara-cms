...
<body>
    ...
    <footer class="bg-[#040181] dark:bg-gray-900 text-white mt-10 pt-10">
            ...
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        ...
                        <p class="max-w-sm mt-2 dark:text-gray-400">Join 31,000+ other and never miss out
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <a href="#"
                                class="block mt-2 text-sm  dark:text-gray-400 hover:underline">community</a>
                        ...
                        <div>
                            ...
                            <span class="block mt-2 text-sm  dark:text-gray-400 hover:underline">+1 526
                                654 8965</span>
                            <span
